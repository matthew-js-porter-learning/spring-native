...
* The original package name 'net.mporter.native' is invalid and this project uses 'com.example.demo' instead.
...
```
$ docker run --rm spring-native-example:0.0.1-SNAPSHOT
```
